                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <li
                                    @click="
                                      llenarLlaveSupervisor(supervisor.key)
                                    "
                                    class="hover:cursor-pointer"
                                    :class="[
                                      active
...
const datosSelect = ref(await infoSelectFolio(2));
...
watch(
  ...
  () => {
    ...
    // console.log(datosSelect.value.distritos);
...
watch(
  ...
  () => {
    ...
    Object.entries(datosSelect.value.tecnicos).forEach(
      ([key, tecnicosArray]) => {
...
const irRutaCorrectivo = async () => {
  let llave;
  llave = await guardarFolio(infoFolioCaptuado.value, 2);
